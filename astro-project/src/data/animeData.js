...
export const animeData = [
    ...
    { id: 2, rank: 2, title: "Ре:Зеро", members: "2 493 142", score: "8.25", poster: "/images/posters/01_Re_Zero.jpg", genre: "Психологический / петля смерти", description: "Главный герой погибает и возвращается во времени, пытаясь спасти близких. Тёмный, эмоционально тяжёлый исэкай с сильным психологическим акцентом и петлями смерти.",
    ...
    { id: 4, rank: 4, title: "О моём перерождении в слизь", members: "1 668 718", score: "8.13", poster: "/images/posters/04_O_moem_pererozhdenii_v_sliz.jpg", genre: "Нация монстров / дипломатия", description: "Слабый слизь постепенно создаёт собственную страну, налаживает отношения между расами и становится одним из самых влиятельных существ мира.",
      details: { malUrl: "https://myanimelist.net/anime/37430/Tensei_shitara_Slime_Datta_Ken" } },
    { id: 5, rank: 5, title: "KonoSuba", members: "2 171 628", score: "8.09", poster: "/images/posters/02_KonoSuba.png", genre: "Комедия / пародия на исэкай",
    ...
    { id: 6, rank: 6, title: "Сон в замке демонов", members: "252 806", score: "7.95", poster: "/images/posters/33_Son_v_zamke_demonov.png", genre: "Комедия в замке",
    ...
    { id: 7, rank: 7, title: "Восхождение героя щита", members: "1 779 394", score: "7.90", poster: "/images/posters/03_Voshozhdenie_geroya_shchita.jpg", genre: "Исекай / месть и рост",
    ...
    { id: 9, rank: 9, title: "Ангел по соседству", members: "464 929", score: "7.85", poster: "/images/posters/20_Angel_po_sosedstvu.jpg", genre: "Романтика / повседневность",
    ...
    { id: 10, rank: 10, title: "Путешествие под предводительством Луны", members: "570 322", score: "7.71", poster: "/images/posters/13_Puteshestvie_pod_predvoditelstvom_Luny.jpg", genre: "Исекай / демоны и люди", description: "Макото Мисуми призван в другой мир как герой, но богиня отвергает его из-за внешности. Благословлённый лунным богом Цукуёми, он строит собственный город, собирает сильных союзников и становится одной из влиятельнейших фигур мира.",
      details: { malUrl: "https://myanimelist.net/anime/43523/Tsuki_ga_Michibiku_Isekai_Douchuu" } },
    { id: 11, rank: 11, title: "Дневник наблюдений за моей невестой-злодейкой", members: "56 618", score: "7.70", poster: "/images/posters/50_Dnevnik_nablyudeniy_za_nevestoy_zlodeykoy.jpg", genre: "Новая злодейка-комедия", description: "Принц Сесил обручён с леди Бертией, которая уверяет, что помнит прошлую жизнь и является переродившейся злодейкой из отомэ-игры. Вместо того чтобы гневаться, он с интересом наблюдает за её попытками следовать злодейскому сценарию. Тёплая и смешная история, рассказанная с необычной точки зрения." ,
      details: { malUrl: "https://myanimelist.net/anime/61687" } },
    { id: 12, rank: 12, title: "Сто девушек которые тебя любят", members: "337 963", score: "7.67", poster: "/images/posters/24_Sto_devushek_kotorye_tebya_lyubyat.png", genre: "Гарем-комедия", description: "Парень должен встречаться сразу со 100 девушками, иначе мир погибнет. Абсурдная, очень смешная и добрая комедия про любовь и хаос.",
      details: { malUrl: "https://myanimelist.net/anime/54714/Kimi_no_Koto_ga_Daidaidaidaidaisuki_na_100-nin_no_Kanojo" } },
    { id: 13, rank: 13, title: "Неторопливый фермер в другом мире", members: "306 019", score: "7.52", poster: "/images/posters/27_Netorpelyvy_fermer.jpg", genre: "Фермерский уют", description: "Программист перерождается фермером и просто хочет спокойно жить. Идеальный расслабленный исэкай про ферму, семью и лёгкий гарем.",
    ...
    { id: 15, rank: 15, title: "Да я паук, и что же?", members: "516 001", score: "7.44", poster: "/images/posters/17_Da_ya_pauk_i_chto_zhe.jpg", genre: "Перерождение в монстра", description: "Школьница перерождается слабой паучихой в подземелье и вынуждена выживать, эволюционируя и становясь сильнее.",
      details: { malUrl: "https://myanimelist.net/anime/37984/Kumo_desu_ga_Nani_ka" } },
    { id: 16, rank: 16, title: "Кулинарные скитания", members: "293 364", score: "7.42", poster: "/images/posters/22_Kulinarnye_skitaniya.jpg", genre: "Слоуслайф + еда", description: "Офисный работник попадает в другой мир и просто хочет спокойно готовить. Тёплый, атмосферный слоуслайф с едой и новыми друзьями." ,
    ...
    { id: 18, rank: 18, title: "Дочь короля демонов слишком добрая", members: "47 697", score: "7.34", poster: "/images/posters/51_Doch_korolya_demonov_slishkom_dobraya.jpg", genre: "Сверх-уютная комедия", description: "Дочь короля демонов невероятно добрая и хочет дружить со всеми. Максимально позитивная и милая история." ,
      details: { malUrl: "https://myanimelist.net/anime/61884" } },
    { id: 19, rank: 19, title: "Всемогущая магия святого", members: "248 393", score: "7.31", poster: "/images/posters/34_Vsemogushchaya_magiya_svyatogo.jpg", genre: "Уютный исэкай", description: "Девушка с невероятной магией святого попадает в другой мир и просто хочет жить спокойно. Тёплая романтика и зельеварение." ,
      details: { malUrl: "https://myanimelist.net/anime/42826" } },
    { id: 20, rank: 20, title: "Моя сводная сестра — бывшая", members: "215 182", score: "7.30", poster: "/images/posters/23_Moya_svodnaya_sestra_byvshaya.jpg", genre: "Романтика", description: "Бывшие возлюбленные внезапно становятся сводными братом и сестрой. Напряжённая, эмоциональная и очень реалистичная романтическая драма." ,
      details: { malUrl: "https://myanimelist.net/anime/49470" } },
    { id: 21, rank: 21, title: "Время пыток принцесса", members: "89 900", score: "7.26", poster: "/images/posters/49_Vremya_pytok_princessa.jpg", genre: "Комедия с пытками", description: "Принцесса обожает пытать людей... но на самом деле она просто очень одинокая и милая. Абсурдная и добрая чёрная комедия." ,
      details: { malUrl: "https://myanimelist.net/anime/55774" } },
    { id: 22, rank: 22, title: "Кума Кума Кума Мишка", members: "190 819", score: "7.23", poster: "/images/posters/42_Kuma_Kuma_Kuma_Mishka.jpg", genre: "Уютный мишка-исэкай",
    ...
    { id: 23, rank: 23, title: "Как госпожа Вельзевул пожелает", members: "107 874", score: "7.22", poster: "/images/posters/48_Kak_gospozha_Velzevul_pozhelaet.jpg", genre: "Сладкая комедия про демонов", description: "Маленькая госпожа демонов и её служанка-горничная. Очень милая, сладкая и смешная повседневная комедия." ,
      details: { malUrl: "https://myanimelist.net/anime/37716" } },
    { id: 24, rank: 24, title: "Подручный Луизы Нулизы", members: "875 975", score: "7.20", poster: "/images/posters/56_Podruchnyy_Luizy_Nulizy.png", genre: "Фэнтези / магия / романтика",
    ...
    { id: 25, rank: 25, title: "Злодейка 99 уровня", members: "195 631", score: "7.13", poster: "/images/posters/40_Zlodeyka_99_urovnya.jpg", genre: "OP-злодейка", description: "Девушка перерождается в злодейку из игры и решает стать самой сильной. Отличный микс комедии, экшена и развития персонажа." ,
      details: { malUrl: "https://myanimelist.net/anime/54837" } },
    { id: 26, rank: 26, title: "Рыцарь-скелет вступает в параллельный мир", members: "386 927", score: "7.13", poster: "/images/posters/55_Rytsar_skelet_v_parallelny_mir.jpg", genre: "Исекай / OP-рыцарь",
