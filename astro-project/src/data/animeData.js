...
export const animeData = [
    { id: 1, rank: 1, title: "Ре:Зеро", members: "2 466 160", score: "8.25", poster: "/images/01_Re_Zero.jpg", genre: "Психологический / петля смерти", description: "Главный герой погибает и возвращается во времени, пытаясь спасти близких. Тёмный, эмоционально тяжёлый исэкай с сильным психологическим акцентом и петлями смерти." },
    { id: 2, rank: 2, title: "KonoSuba", members: "2 156 530", score: "8.09", poster: "/images/02_KonoSuba.png", genre: "Комедия / пародия на исэкай",
    ...
    { id: 3, rank: 3, title: "Восхождение героя щита", members: "1 770 714", score: "7.90", poster: "/images/03_Voshozhdenie_geroya_shchita.jpg", genre: "Исекай / месть и рост", description: "Преданный герой со щитом, которого все презирают. Постепенно становится сильнее, собирает команду и ищет справедливость в жестоком мире." },
    { id: 4, rank: 4, title: "О моём перерождении в слизь", members: "1 650 395", score: "8.13", poster: "/images/04_O_moem_pererozhdenii_v_sliz.jpg", genre: "Нация монстров / дипломатия", description: "Слабый слизь постепенно создаёт собственную страну, налаживает отношения между расами и становится одним из самых влиятельных существ мира." },
    { id: 5, rank: 5, title: "Реинкарнация безработного", members: "1 580 579", score: "8.33", poster: "/images/05_Reinkarnatsiya_bezrabotnogo.jpg", genre: "Магический мир / взросление", description: "Перерождённый неудачник серьёзно подходит к новой жизни. Постепенно становится одним из сильнейших магов мира, проходя путь искупления и роста." },
    { id: 6, rank: 6, title: "Дракон-горничная госпожи Кобаяши", members: "1 331 493", score: "7.90", poster: "/images/06_Drakon_gornichnaya_gospozhi_Kobayasi.jpg", genre: "Повседневность с драконами", description: "Обычная офисная работница живёт вместе с драконами в современном мире. Тёплая, милая и очень смешная повседневная комедия." },
    { id: 7, rank: 7, title: "Волчица и пряности", members: "872 861", score: "8.21", poster: "/images/07_Volchitsa_i_pryanosti.jpg", genre: "Торговля и волчица", description: "Мудрый торговец путешествует вместе с древней богиней-волчицей. История о экономике, философии и медленно развивающихся отношениях в средневековом мире." },
    { id: 8, rank: 8, title: "Арифурэта", members: "819 907", score: "6.72", poster: "/images/08_Arifureta.jpg", genre: "Тёмный исэкай / месть", description: "Преданный и брошенный в бездну герой проходит через ад, чтобы стать невероятно сильным. Мрачная история мести и выживания с элементами гарема." },
    { id: 9, rank: 9, title: "Как не призвать князя тьмы", members: "800 543", score: "6.81", poster: "/images/09_Kak_ne_prizvat_knyazya_tmy.jpg", genre: "Экки / гарем + контроль", description: "Главный герой попадает в мир игры и использует магию порабощения на демонах и людях. Смесь экки, гарема и чунибё." },
    { id: 10, rank: 10, title: "Внук мудреца", members: "663 466", score: "6.62", poster: "/images/10_Vnuk_mudretsa.jpg", genre: "Гений магии / академия", description: "Внук величайшего мудреца с огромной силой, но почти без социального интеллекта. Поступает в магическую академию и быстро становится знаменитостью." },
    { id: 11, rank: 11, title: "Маг-целитель: Новый старт", members: "645 886", score: "6.31", poster: "/images/11_Mag_tselitel_Novyy_start.jpg", genre: "Тёмный revenge / исцеление", description: "Бывший целитель, которого предали, возвращается во времени и мстит своим обидчикам крайне жестокими методами. Один из самых тёмных и жёстких тайтлов в жанре." },
    { id: 12, rank: 12, title: "В другом мире со смартфоном", members: "630 955", score: "6.10", poster: "/images/12_V_drugom_mire_so_smartfonom.jpg", genre: "Исекай / гарем + повседневность",
    ...
    { id: 13, rank: 13, title: "Путешествие под предводительством Луны", members: "562 887", score: "7.72", poster: "/images/13_Puteshestvie_pod_predvoditelstvom_Luny.jpg", genre: "Исекай / демоны и люди", description: "Героя призвали, но богиня его отвергла. Он уходит жить к демонам и постепенно становится крайне влиятельной фигурой." },
    { id: 14, rank: 14, title: "Рапсодия о долгом странствии", members: "560 637", score: "6.43", poster: "/images/14_Rapsodiya_o_dolgom_stranstvii.jpg", genre: "Исекай / расслабленный OP", description: "Программист попадает в мир игры с читерскими способностями и просто путешествует, исследует и собирает компанию." },
    { id: 15, rank: 15, title: "Брошенный кролик", members: "526 286", score: "8.32", poster: "/images/15_Broshennyy_krolik.jpg", genre: "Слоуслайф / отцовство", description: "30-летний холостяк внезапно становится опекуном маленькой девочки. Очень тёплая и душевная история взросления." },
    { id: 16, rank: 16, title: "Bakarina (Злодейка)", members: "512 515", score: "7.44", poster: "/images/16_Bakarina_Zlodeyka.jpg", genre: "Злодейка / избегает флагов", description: "Девушка перерождается в роль злодейки из отомэ-игры и отчаянно пытается избежать всех плохих концовок." },
    { id: 17, rank: 17, title: "Да я паук, и что же?", members: "511 638", score: "7.40", poster: "/images/17_Da_ya_pauk_i_chto_zhe.jpg", genre: "Перерождение в монстра", description: "Школьница перерождается слабой паучихой в подземелье и вынуждена выживать, эволюционируя и становясь сильнее." },
    { id: 18, rank: 18, title: "Мифический дух: хроники", members: "457 198", score: "7.06", poster: "/images/18_Mificheskiy_duh_hroniki.jpg", genre: "Реинкарнация / месть и магия", description: "Студент погибает и перерождается в другом мире. Пытается отомстить за свою семью и раскрывает тайны своего прошлого." },
    { id: 19, rank: 19, title: "300 лет убивала слизней", members: "451 528", score: "6.89", poster: "/images/19_300_let_ubivala_slizney.jpg", genre: "Уютный исэкай / повседневность",
    ...
    { id: 20, rank: 20, title: "Ангел по соседству", members: "450 000", score: "7.86", poster: "/images/20_Angel_po_sosedstvu.jpg", genre: "Романтика / повседневность", description: "Замкнутый парень и идеальная девушка-соседка постепенно сближаются. Очень милая и душевная школьная романтика." },
    { id: 21, rank: 21, title: "Я получил читерские способности", members: "395 000", score: "6.33", poster: "/images/21_Ya_poluchil_chiterskie_sposobnosti.jpg", genre: "OP в двух мирах", description: "Студент с инвалидностью получает невероятные способности в параллельном мире и возвращается в реальный. История про рост, месть и силу в двух мирах." },
    { id: 22, rank: 22, title: "Кулинарные скитания", members: "341 000", score: "7.68", poster: "/images/22_Kulinarnye_skitaniya.jpg", genre: "Слоуслайф + еда", description: "Офисный работник попадает в другой мир и просто хочет спокойно готовить. Тёплый, атмосферный слоуслайф с едой и новыми друзьями." },
    { id: 23, rank: 23, title: "Моя сводная сестра — бывшая", members: "342 000", score: "6.72", poster: "/images/23_Moya_svodnaya_sestra_byvshaya.jpg", genre: "Романтика", description: "Бывшие возлюбленные внезапно становятся сводными братом и сестрой. Напряжённая, эмоциональная и очень реалистичная романтическая драма." },
    { id: 24, rank: 24, title: "Сто девушек которые тебя любят", members: "333 248", score: "7.68", poster: "/images/24_Sto_devushek_kotorye_tebya_lyubyat.png", genre: "Гарем-комедия", description: "Парень должен встречаться сразу со 100 девушками, иначе мир погибнет. Абсурдная, очень смешная и добрая комедия про любовь и хаос." },
    { id: 25, rank: 25, title: "Сильнейший мудрец низшей эмблемы", members: "299 282", score: "6.22", poster: "/images/25_Silneyshiy_mudrets_nizshey_emblemy.jpg", genre: "OP-мудрец", description: "Гений магии перерождается с самой слабой эмблемой и с нуля становится сильнейшим. Классический OP-исэкай с отличным развитием." },
    { id: 26, rank: 26, title: "Гарем рабов в лабиринте", members: "299 000", score: "6.53", poster: "/images/26_Garem_rabov_v_labirinte.jpg", genre: "Жёсткий экки-гарем", description: "Главный герой строит гарем рабынь в лабиринте другого мира. Один из самых explicit и детализированных тайтлов жанра (18+)." },
    { id: 27, rank: 27, title: "Неторопливый фермер в другом мире", members: "297 000", score: "7.53", poster: "/images/27_Netorpelyvy_fermer.jpg", genre: "Фермерский уют", description: "Программист перерождается фермером и просто хочет спокойно жить. Идеальный расслабленный исэкай про ферму, семью и лёгкий гарем." },
    { id: 28, rank: 28, title: "Чёрный призыватель", members: "297 000", score: "7.01", poster: "/images/28_Cherny_prizyvatel.jpg", genre: "Призыв + OP", description: "Парень с уникальной способностью призыва становится невероятно сильным. Тёмный, стильный и очень динамичный исэкай." },
    { id: 29, rank: 29, title: "Восьмой сын? Я так не думаю!", members: "276 645", score: "6.28", poster: "/images/29_Vosmoy_syn.jpg", genre: "Классический OP", description: "Мальчик из большой семьи перерождается восьмым сыном аристократа и быстро раскрывает свой потенциал. Лёгкий и приятный исэкай." },
    { id: 30, rank: 30, title: "Перевоплотился в седьмого принца", members: "268 000", score: "7.41", poster: "/images/30_Perevoplotilsya_v_sedmogo_princa.jpg", genre: "OP-магия + ребёнок", description: "Взрослый маг перерождается маленьким принцем с невероятной жаждой знаний. Один из самых милых и позитивных OP-исэкаев последних лет." },
    { id: 31, rank: 31, title: "Жизнь перерожденного мудреца", members: "255 116", score: "6.33", poster: "/images/31_Zhizn_perezhdennogo_mudretsa.jpg", genre: "OP + вторая профессия", description: "Величайший мудрец перерождается и выбирает 'вторую профессию'. Спокойная, умная история про жизнь после пика силы." },
    { id: 32, rank: 32, title: "Избранный богами", members: "255 000", score: "6.96", poster: "/images/32_Izbrannyy_bogami.jpg", genre: "Уютный исэкай", description: "Взрослый мужчина перерождается ребёнком и начинает бизнес со слаймами. Очень тёплый, добрый и расслабленный тайтл." },
    { id: 33, rank: 33, title: "Сон в замке демонов", members: "250 000", score: "7.95", poster: "/images/33_Son_v_zamke_demonov.png", genre: "Комедия в замке", description: "Принцесса постоянно спит и видит сны в замке демонов. Безумно смешная, милая и очень оригинальная комедия." },
    { id: 34, rank: 34, title: "Всемогущая магия святого", members: "247 000", score: "7.32", poster: "/images/34_Vsemogushchaya_magiya_svyatogo.jpg", genre: "Уютный исэкай", description: "Девушка с невероятной магией святого попадает в другой мир и просто хочет жить спокойно. Тёплая романтика и зельеварение." },
    { id: 35, rank: 35, title: "Укротитель зверей изгнанный", members: "245 000", score: "6.90", poster: "/images/35_Ukrotitel_zverey_izgnannyy.jpg", genre: "OP-укротитель", description: "Героя с 'бесполезной' способностью изгоняют, но он становится сильнейшим укротителем монстров. Классический revenge + рост." },
    { id: 36, rank: 36, title: "Плод эволюции", members: "220 000", score: "6.16", poster: "/images/36_Plod_evolyutsii.jpg", genre: "Эволюция + гарем", description: "Класс из 30 человек эволюционирует в монстров. Главный герой становится самым сильным и собирает гарем сильных спутниц." },
    { id: 37, rank: 37, title: "Средние способности (Mile)", members: "217 000", score: "6.74", poster: "/images/37_Srednie_sposobnosti.jpg", genre: "Лёгкий исэкай",
    ...
    { id: 38, rank: 38, title: "Я на самом деле самый сильный?", members: "212 000", score: "6.47", poster: "/images/38_Ya_na_samom_dele_samyi_silny.jpg", genre: "OP с твистом", description: "Мальчик с огромной силой думает, что он средний. Очень милая история про детство, друзей и скрытую мощь." },
    { id: 39, rank: 39, title: "Жизнь со сводной сестрой", members: "211 000", score: "7.32", poster: "/images/39_Zhizn_so_svodnoy_sestroy.jpg", genre: "Романтика", description: "Парень и девушка, потерявшие родителей, начинают жить вместе как сводные. Тёплая, взрослая и очень душевная романтика." },
    { id: 40, rank: 40, title: "Злодейка 99 уровня", members: "210 000", score: "7.15", poster: "/images/40_Zlodeyka_99_urovnya.jpg", genre: "OP-злодейка", description: "Девушка перерождается в злодейку из игры и решает стать самой сильной. Отличный микс комедии, экшена и развития персонажа." },
    { id: 41, rank: 41, title: "Перестану быть героем", members: "192 000", score: "6.90", poster: "/images/41_Perestanu_byt_gerоем.jpg", genre: "Герой уходит к демонам", description: "Герой разочаровывается в людях и уходит жить к демонам. Интересная история про выбор стороны и настоящую справедливость." },
    { id: 42, rank: 42, title: "Кума Кума Кума Мишка", members: "189 000", score: "7.24", poster: "/images/42_Kuma_Kuma_Kuma_Mishka.jpg", genre: "Уютный мишка-исэкай", description: "Девушка в костюме мишки спасает мир и заводит друзей. Один из самых милых, добрых и позитивных исэкаев всех времён." },
    { id: 43, rank: 43, title: "Мир Лидейл", members: "189 947", score: "6.97", poster: "/images/43_Mir_Lideyl.jpg", genre: "Бабушка в MMORPG", description: "Пожилая женщина попадает в MMORPG в теле своей аватарки. Очень милая, взрослая и необычная история про второй шанс." },
    { id: 44, rank: 44, title: "Безымянная память", members: "159 144", score: "6.83", poster: "/images/44_Bezymiannaya_pamyat.jpg", genre: "Фэнтези-романтика", description: "Девушка с таинственным прошлым и юноша, потерявший память. Красивая романтическая история в фэнтезийном мире." },
    { id: 45, rank: 45, title: "Цубакума (UzaMaid!)", members: "150 000", score: "7.00", poster: "/images/45_Tsubakuma_UzaMaid.jpg", genre: "Горничная-комедия", description: "Бывшая солдатка становится горничной у маленькой девочки. Безумно смешная и милая комедия про семью и привязанность." },
    { id: 46, rank: 46, title: "Я стал самым сильным с провальным навыком", members: "150 000", score: "6.80", poster: "/images/46_Samyi_silny_s_provalnym_navykom.jpg", genre: "Тёмный revenge", description: "Парня с 'провальным' навыком предают. Он становится монстром мести. Жёсткий, мрачный и очень зрелищный тайтл." },
    { id: 47, rank: 47, title: "Ради своей дочери я смогу победить даже короля демонов", members: "116 041", score: "7.08", poster: "/images/47_Radi_svoey_docheri.jpg", genre: "Уютная история про дочь", description: "Обычный отец попадает в другой мир ради спасения дочери. Одна из самых тёплых и душевных историй про отцовство." },
    { id: 48, rank: 48, title: "Как госпожа Вельзевул пожелает", members: "107 930", score: "7.24", poster: "/images/48_Kak_gospozha_Velzevul_pozhelaet.jpg", genre: "Сладкая комедия про демонов", description: "Маленькая госпожа демонов и её служанка-горничная. Очень милая, сладкая и смешная повседневная комедия." },
    { id: 49, rank: 49, title: "Время пыток принцесса", members: "89 000", score: "7.30", poster: "/images/49_Vremya_pytok_princessa.jpg", genre: "Комедия с пытками", description: "Принцесса обожает пытать людей... но на самом деле она просто очень одинокая и милая. Абсурдная и добрая чёрная комедия." },
    { id: 50, rank: 50, title: "Дневник наблюдений за моей невестой-злодейкой", members: "90 000", score: "7.10", poster: "/images/50_Dnevnik_nablyudeniy_za_nevestoy_zlodeykoy.jpg", genre: "Новая злодейка-комедия", description: "Парень попадает в тело злодея и пытается избежать плохого конца. Весёлая история про злодейку и её 'жертву'." },
    { id: 51, rank: 51, title: "Дочь короля демонов слишком добрая", members: "46 000", score: "7.35", poster: "/images/51_Doch_korolya_demonov_slishkom_dobraya.jpg", genre: "Сверх-уютная комедия", description: "Дочь короля демонов невероятно добрая и хочет дружить со всеми. Максимально позитивная и милая история." },
    { id: 52, rank: 52, title: "Похоже сильнейшая профессия — временный инспектор", members: "41 924", score: "6.09", poster: "/images/52_Pohozhe_silneyshaya_professiya.jpg", genre: "Новый OP-инспектор", description: "Парень с читерской силой становится временным инспектором. Лёгкий, динамичный исэкай с отличным чувством юмора." },
    { id: 53, rank: 53, title: "Добро пожаловать в дешёвый ресторан изгнанника", members: "50 000", score: "7.00", poster: "/images/53_Dobro_pozhalovat_v_deshevyi_restoran.jpg", genre: "Уютный ресторанный исэкай", description: "Изгнанный герой открывает ресторан в другом мире. Тёплый слоуслайф про еду, друзья и новую жизнь." },
    { id: 54, rank: 54, title: "В команде героя была милая девушка поэтому я признался ей", members: "36 481", score: "6.23", poster: "/images/54_V_komande_geroya_byla_milaya_devushka.jpg", genre: "Лёгкая романтика", description: "Обычный член команды героя влюбляется в милую соратницу. Простая, милая и очень душевная история первой любви." }
];
