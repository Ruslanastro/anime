    ...
    { id: 35, rank: 36, title: "Укротитель зверей изгнанный", members: "247 220", score: "6.90", shikimoriScore: "6.90", poster: "/images/posters/35_Ukrotitel_zverey_izgnannyy.jpg", genre: "OP-укротитель", description: "Героя с 'бесполезной' способностью изгоняют, но он становится сильнейшим укротителем монстров. Классический revenge + рост.",
      details: {
        ...
        mainCharacters: [
          ...
          { name: "Сора", desc: "Дриада из Племени Духов, старшая близняшка. Хранительница Щита Истин, контракт №3.", image: "/images/characters/Sora.jpg" },
          { name: "Руна", desc: "Дриада из Племени Духов, младшая близняшка. Усиливает заклинания, контракт №4.", image: "/images/characters/Runa.jpg" },
          { name: "Нина", desc: "Полубогиня с лисьими хвостами. Божественный щит и телепортация, контракт №5.", image: "/images/characters/Nina.jpg" },
...
export const ecchiData = [
    { title: "Гарем рабов в лабиринте другого мира", reason: "Самый откровенный исэкай. Детальные 18+ сцены почти без цензуры, рабство + гарем (рейтинг R+)", level: 97, note: "Лучший по детализации в жанре" },
    { title: "Маг-целитель: Новый старт", reason: "Месть с эротическими сценами. R+ тег «эротика», детальные 18+ моменты — почти хентай", level: 95, note: "Тёмная история с откровенными сценами" },
    { title: "Как не призвать князя тьмы", reason: "Тег «этти», подчинение, постоянные откровенные сцены с суккубами и гаремом", level: 90 },
    { title: "Арифурэта", reason: "Откровенные сцены с Юэ и Шия, цензура едва прикрывает детали", level: 82 },
    { title: "Сто девушек которые очень-очень сильно тебя любят", reason: "Комедийный экки: падения, панцу-шоты, откровенные шутки на каждом шагу", level: 80 },
    { title: "Плод эволюции", reason: "Откровенные сцены, бани, гарем с монстрами и «случайные» моменты", level: 72 },
    { title: "Реинкарнация безработного", reason: "Постоянные падения, бани, гаремные моменты — экки заметный, но не основной элемент", level: 65 },
    { title: "Дракон-горничная госпожи Кобаяши", reason: "Лукоа полуголая почти постоянно, обильный фансервис с драконами", level: 60 },
    { title: "Неторопливый фермер в другом мире", reason: "Большой гарем из жён, бани, фансервис на ферме", level: 55 },
    { title: "Подручный Луизы Нулизы", reason: "Извращённые шутки Сайто, панцу, гаремные моменты", level: 50 },
    { title: "Я получил читерские способности", reason: "Гарем из девушек в доме, постоянный фансервис", level: 50 },
    { title: "KonoSuba", reason: "Панцу-шоты, бани, суккуб-сцены, извращённые шутки", level: 45 },
    { title: "Рыцарь-скелет вступает в параллельный мир", reason: "Купальни, полуобнажённые сцены, рейтинг R", level: 45 },
    { title: "Мифический дух: хроники", reason: "Гарем, банные сцены, Латифа и другие девушки", level: 45 },
    { title: "Рапсодия о долгом странствии", reason: "Гарем, бани, панцу-шоты (Death March)", level: 45 },
    { title: "Мятежная компания", reason: "Моэ-фансервис, бани, шуточки — умеренно", level: 40 },
    { title: "Чёрный призыватель", reason: "Гарем и бани, но умеренно", level: 40 },
    { title: "В другом мире со смартфоном", reason: "Гарем, панцу, бани, но сцены умеренные", level: 40 },
    { title: "Я на самом деле самый сильный?", reason: "Фансервис с богиней, демонессой и баней", level: 40 },
    { title: "Цубакума (UzaMaid!)", reason: "Лоликон-намёки, наряды, сёдзё-ай юмор", level: 30 },
    { title: "Внук мудреца", reason: "Банные сцены, купальники — умеренно", level: 30 },
    { title: "Я стал самым сильным с провальным навыком", reason: "Лёгкий фансервис, экшн доминирует", level: 30 },
    { title: "Жизнь перерожденного мудреца", reason: "Слизи-девочки, лёгкий фансервис", level: 30 },
    { title: "Укротитель зверей изгнанный", reason: "Гарем формируется, фансервис лёгкий", level: 25 },
    { title: "Восьмой сын? Я так не думаю!", reason: "Детский гарем, лёгкие моменты", level: 25 }
];
